...
- Keywords: biological, variation, creation, beginnings, patience, size, journey, style.
...
- Keywords: rational, decisions, reason, logical, thoughs, equal weight on every possibility, justice.
...
- Keywords: trust, confirmation, harmony, acceptance, optimism, belief, getting the green light or a go ahead, yes, religion, moral.
...
- Keywords: disconnected, apathetic, indifference, detachment, options, liberties, freedom, independence, movement, separated, flexibility, airy, inangible.
...
- Keywords: healing, energy, grow, increasing/raising, authority/power, luxury, reckless.
...
- Keywords: mechanical, repetition, destruction, endings, precision, impatience, time (present, past, future).
...
- Keywords: hate or fear, refusal, defiance, rejection, skeptical criticism, doubt, negativity, despair, getting the red light or a hard stop, no, deception.
...
- Keywords: connection, commitment, attachment, obligation, promises, responsability, dependence, stable, united, inflexible, earthy, material, tangible.
...
- Keywords: harming, pessimism, sacrifice, withdraw, wisdom, system, acceptance, control/limits, law, empathy, poison, corruption.
...
- Keywords: infinite possibilities, indifference, confusion, darkening, secrets, doubt, irrelevance, questions, nothingness, occult.